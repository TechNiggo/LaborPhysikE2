...
\renewcommand{\versuch}{E2} %Versuchnummer
\renewcommand{\versuchtitel}{Kennlinien und Wirkungsgrade von Brennstoffzellen} %Versuchtitel
\renewcommand{\betreuer}{Frau Dr. Nicolaus} %Versuchtitel
\renewcommand{\datum}{31. November 2017} %Datum
